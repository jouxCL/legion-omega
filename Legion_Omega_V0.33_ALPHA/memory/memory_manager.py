...
from orchestrator.budget_manager import calculate_cost
from orchestrator.costs import AGENT_MODELS
...
DEFAULT_MEMORY = {
    ...
    "token_usage": {
        "orchestrator": {"input": 0, "output": 0, "cost_usd": 0.0},
        "logic_agent":   {"input": 0, "output": 0, "cost_usd": 0.0},
        "ui_agent":      {"input": 0, "output": 0, "cost_usd": 0.0},
        "qa_agent":      {"input": 0, "output": 0, "cost_usd": 0.0},
        "context_agent": {"input": 0, "output": 0, "cost_usd": 0.0},
        "total_cost_usd": 0.0
    },
